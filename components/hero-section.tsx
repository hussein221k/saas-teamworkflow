                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants as any}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm font-bold tracking-tight uppercase">Introducing Neural Task Subroutines</span>
                                ...
                                <TextEffect
                                    ...
                                    Highly customizable tactical clusters for building modern enterprises. Orchestrate your team with the precision and power of UNIT-01 architecture.
                                </TextEffect>
                        ...
                        <div className="group-hover:blur-sm mx-auto mt-12 grid max-w-2xl grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14 grayscale opacity-40">
                            <div className="flex items-center justify-center gap-2">
                                <Image
                                    ...
                                    suppressHydrationWarning
                                />
                                <span className="text-sm font-black tracking-tighter hidden md:block">PRISMA</span>
                            </div>
                            ...
                            <div className="flex items-center justify-center gap-2">
                                <Image
                                    ...
                                    suppressHydrationWarning
                                />
                                <span className="text-sm font-black tracking-tighter hidden md:block uppercase">Arcjet</span>
                            </div>
                            <div className="flex items-center justify-center gap-2">
                                <Image
                                    className="h-5 w-auto dark:invert"
                                    ...
                                    suppressHydrationWarning
                                />
                                <span className="text-sm font-black tracking-tighter hidden md:block">NEXT.JS</span>
                            </div>
                            <div className="flex items-center justify-center gap-2">
                                <Image
                                    className="h-5 w-auto dark:invert"
                                    src="https://kinde.com/favicon.ico"
                                    alt="Kinde Logo"
                                    width={20}
                                    height={20}
                                    suppressHydrationWarning
                                />
                                <span className="text-sm font-black tracking-tighter hidden md:block">KINDE</span>
                            </div>
                            <div className="flex items-center justify-center gap-2">
                                <Image
                            ...
                            <div className="flex items-center justify-center gap-2">
                                <Image
                                    ...
                                    suppressHydrationWarning
                                />
                                <span className="text-[10px] font-black tracking-tighter hidden md:block">TANSTACK</span>
                            </div>
                            <div className="flex items-center justify-center gap-2">
                                <Image
                                    className="h-5 w-auto dark:invert"
                                    ...
                                    suppressHydrationWarning
                                />
                                <span className="text-[10px] font-black tracking-tighter hidden md:block">RADIX UI</span>
                            </div>

                            <div className="flex items-center justify-center gap-2">
                                <div className="w-6 h-6 rounded bg-primary flex items-center justify-center font-black text-[10px] text-white shadow-[0_0_10px_rgba(var(--primary),0.3)]">U1</div>
                                <span className="text-[10px] font-black tracking-[0.2em] hidden md:block text-zinc-400">UNIT-01</span>
                            </div>
                        </div>
                    </div>
                </section>
