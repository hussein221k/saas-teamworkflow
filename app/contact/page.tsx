...
import { Mail, MessageCircle, ArrowLeft, Globe, Send, ShieldCheck } from "lucide-react";
...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col items-center justify-center p-6">
      ...
      <div ref={contentRef} className="max-w-xl w-full relative z-10 space-y-12">
        {/* Back Link */}
        <Link href="/" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors group mb-8">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Back to HQ</span>
        </Link>

        {/* Header */}
        <div className="space-y-4">
            <Badge variant="outline" className="border-white/10 bg-white/5 text-primary uppercase tracking-[0.3em] font-black text-[10px] px-3">
                Emergency Uplink
            </Badge>
            ...
            <p className="text-zinc-500 font-medium leading-relaxed">
                Need priority support or custom integration? Our lead developers are standing by for direct transmission.
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
            ...
            >
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h3 className="text-sm font-bold uppercase tracking-widest italic">Signal via Email</h3>
                        <p className="text-[10px] text-zinc-500 font-bold">dev@teamworkflow.ai</p>
                    </div>
                </div>
            ...
            >
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h3 className="text-sm font-bold uppercase tracking-widest italic">Direct WhatsApp</h3>
                        <p className="text-[10px] text-zinc-500 font-bold">Encrypted Link Available</p>
                    </div>
                </div>
