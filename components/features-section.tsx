...
import { ShieldCheck, Zap, Cpu, Users, Globe, Lock, QrCode, LayoutDashboard } from "lucide-react";
import { cn } from "@/lib/utils";

const features = [
  {
    title: "Strategic Command",
    description: "Centralized Admin Panel with bird's eye view over every project unit and team deployment.",
  ...
  },
  {
    ...
    description: "Instant team joining via high-fidelity QR codes and secure protocol strings.",
  ...
  },
  {
    ...
    description: "Arcjet-powered security layer protecting your neural network from SQLi, XSS, and bot intrusions.",
  ...
  },
  {
    ...
    description: "Leverage built-in AI nodes to assist in task management and cluster optimization.",
  ...
  },
  {
    ...
    description: "Deploy across infinite clusters and teams without losing coordination or protocol integrity.",
  ...
  },
  {
    ...
    description: "Advanced employee authorization and decommissioning protocols with fine-grained control.",
    ...
    <section ref={containerRef} className="relative py-24 bg-zinc-950 overflow-hidden">
      ...
      <motion.div style={{ opacity, scale }} className="container mx-auto px-6">
        <div className="text-center mb-20">
          ...
          >
            A high-performance infrastructure designed for modern engineering clusters and mission-critical workflows.
          </motion.p>
        </div>
